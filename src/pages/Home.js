...
function Home() {
  ...
  const AssignDomain = async () => {
    try {
      ...
      const response = await axiosInstance.post(`/api/subdomain`, subDomain);
                    ...
                    <Dropdown.Header className="w-96">
                      <form class="w-full mx-auto">
                        ...
                        <div class="relative">
                          ...
                          <input
                            ...
                            placeholder="Search and register sub domain"
                            required
                            value={subDomain}
                          ...
                          <button
                            type="submit"
                            class="text-white absolute end-2.5 bottom-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-1.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                          >
                            Assign
                          </button>
                        </div>
                      ...
                      <div>
                        <h2 className="mt-3 text-start font-serif text-green-500">
                          Subdomain available! Proceed by clicking the publish
                          button to assign it to our webpage.
                        </h2>
                      </div>
                    </Dropdown.Header>
